...
public extension UIColor {
    ...
    ///   - alpha: Color's alpha.
    @objc internal convenience init(hue: CGFloat, saturation: CGFloat, lightness: CGFloat, alpha: CGFloat) {
    ...
    ///   How to use?
    ///   `UIColor(0x000000)`
    internal convenience init(_ hexValue: UInt,_ alpha: CGFloat = 1.0) {
    ...
    internal func getHSLA() -> (hue: CGFloat, saturation: CGFloat, lightness: CGFloat, alpha: CGFloat)? {
        var hue: CGFloat = 0
    ...
    @objc static let callTheme: ColorTheme = ColorTheme()
    ...
    @objcMembers class ColorTheme: NSObject {
        ...
        public var primaryDarkColor: UIColor {
            UIColor.callTheme.primaryColor6
        }
        
        public var primaryLightColor: UIColor {
            UIColor.callTheme.primaryColor5
        }
...
@objcMembers public class GradientColors: NSObject {
    public static var gradientColors0: [UIColor] = [UIColor.callTheme.primaryColor0,UIColor.ColorTheme.gradientEndColor(lightness: .two)]

    public static var graduentColors1: [UIColor] = [UIColor.callTheme.primaryColor1,UIColor.ColorTheme.gradientEndColor(lightness: .three)]

    public static var graduentColors2: [UIColor] = [UIColor.callTheme.primaryColor2,UIColor.ColorTheme.gradientEndColor(lightness: .four)]

    public static var graduentColors3: [UIColor] = [UIColor.callTheme.primaryColor3,UIColor.ColorTheme.gradientEndColor(lightness: .five)]

    public static var graduentColors4: [UIColor] = [UIColor.callTheme.primaryColor4,UIColor.ColorTheme.gradientEndColor(lightness: .six)]

    public static var graduentColors5: [UIColor] = [UIColor.callTheme.primaryLightColor,UIColor.ColorTheme.gradientEndColor(lightness: .seven)]

    public static var graduentColors6: [UIColor] = [UIColor.callTheme.primaryDarkColor,UIColor.ColorTheme.gradientEndColor(lightness: .seventyFive)]

    static var graduentColors7: [UIColor] = [UIColor.callTheme.primaryColor7,UIColor.ColorTheme.gradientEndColor(lightness: .eight)]

    static var graduentColors8: [UIColor] = [UIColor.callTheme.primaryColor8,UIColor.ColorTheme.gradientEndColor(lightness: .eightyFive)]

    static var graduentColors9: [UIColor] = [UIColor.callTheme.primaryColor9,UIColor.ColorTheme.gradientEndColor(lightness: .ninety)]

    static var graduentColors95: [UIColor] = [UIColor.callTheme.primaryColor95,UIColor.ColorTheme.gradientEndColor(lightness: .ninetyFive)]

    static var graduentColors98: [UIColor] = [UIColor.callTheme.primaryColor98,UIColor.ColorTheme.gradientEndColor(lightness: .ninety)]
}
